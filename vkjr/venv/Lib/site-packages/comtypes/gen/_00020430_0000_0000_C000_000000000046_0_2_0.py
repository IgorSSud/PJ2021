...
IFontDisp = Font
__all__ = [ 'OLE_COLOR', 'Picture', 'IFontEventsDisp', 'FONTITALIC',
           'IFontDisp', 'OLE_XPOS_CONTAINER', 'OLE_XSIZE_CONTAINER',
           'Unchecked', 'OLE_OPTEXCLUSIVE', 'Font', 'OLE_CANCELBOOL',
           'StdFont', 'FONTBOLD', 'OLE_HANDLE', 'Checked',
           'IPictureDisp', 'OLE_YSIZE_CONTAINER',
           'LoadPictureConstants', 'Color', 'FONTNAME',
           'OLE_XSIZE_PIXELS', 'FONTUNDERSCORE', 'FONTSIZE',
           'OLE_YPOS_HIMETRIC', 'OLE_XSIZE_HIMETRIC', 'Gray',
           'OLE_XPOS_HIMETRIC', 'Monochrome', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_YPOS_CONTAINER', 'StdPicture', 'OLE_YSIZE_HIMETRIC',
           'IPicture', 'IFont', 'OLE_XPOS_PIXELS', 'OLE_YSIZE_PIXELS',
           'FontEvents', 'Default', 'OLE_YPOS_PIXELS', 'OLE_TRISTATE',
           'VgaColor', 'FONTSTRIKETHROUGH']
